...
module.exports = {
  ...
  module: {
    rules: [
        ...
        {
            test: /\.s[ac]ss$/,
            use: [MiniCssExtractPlugin.loader, "css-loader", "sass-loader"], // sass-loader将sass编译成css
        },
        {
            test: /\.styl$/,
            use: [MiniCssExtractPlugin.loader, "css-loader", "stylus-loader"], // stylus-loader将 Styl 文件编译成 Css 文件
        },
